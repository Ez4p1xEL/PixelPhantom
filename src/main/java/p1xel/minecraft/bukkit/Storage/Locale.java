...
public class Locale {
    ...
    public static void createFile() {
        ...
        for (String l : langs) {
            File file = new File(PixelPhantom.getInstance().getDataFolder(), l + ".yml");
            if (!file.exists()) {
                PixelPhantom.getInstance().saveResource(l + ".yml", false);
            }
        }
    }

    public static FileConfiguration get() {
        File file = new File(PixelPhantom.getInstance().getDataFolder(), Config.getLanguage() + ".yml");
